                    ...
                    <div class="col-md-6">
                      ...
                      <label for="dept" class="form-label order-sm-2 mt-3">Department of Nominee:</label>
                        <select id="dept" name="dept" class="form-select">
                          <option value="CSE Department" <?php if($nominee['dept']=='CSE Department'){echo "selected";} ?>>CSE Department</option>
                          <option value="ISE Department" <?php if($nominee['dept']=='ISE Department'){echo "selected";} ?>>ISE Department</option>
                          <option value="ME Department" <?php if($nominee['dept']=='ME Department'){echo "selected";} ?>>ME Department</option>
                          <option value="EC Department" <?php if($nominee['dept']=='EC Department'){echo "selected";} ?>>EC Department</option>
                          <option value="IOT Department" <?php if($nominee['dept']=='IOT Department'){echo "selected";} ?>>IOT Department</option>
                          <option value="AI Department" <?php if($nominee['dept']=='AI Department'){echo "selected";} ?>>AI Department</option>
                          <option value="AE Department" <?php if($nominee['dept']=='AE Department'){echo "selected";} ?>>AE Department</option>
                          <option value="MT Department" <?php if($nominee['dept']=='MT Department'){echo "selected";} ?>>MT Department</option>
                        </select>

                      <label for="post" class="form-label order-sm-2 mt-3">Nominee for the Position:</label>    
                        <select id="post" name="post" class="form-select">
                        <option value="President" <?php if($nominee['post']=='President'){echo "selected";} ?>>President</option>
                        <option value="Vice President" <?php if($nominee['post']=='Vice President'){echo "selected";} ?>>Vice President</option>
