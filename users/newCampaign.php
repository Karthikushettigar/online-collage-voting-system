                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-6">
                                            <label class="form-label" for="c">Select the Specific year that you have campaigned : </label><br>

                                            <input class="size visually-hidden" type="radio" name="size" id="l" value="col-4 col-md-2">
                                                <label class="size btn btn-light m-1" style="cursor: pointer;" for="ll">ll year</label>
                                            <input class="size visually-hidden" type="radio" name="size" id="xl" value="col-8 col-md-4">
                                                <label class="size btn btn-light m-1" style="cursor: pointer;" for="ll">lll year</label>
                                            <input class="size visually-hidden" type="radio" name="size" id="xxl" value="col-12 col-md-6">
                                                <label class="size btn btn-light m-1" style="cursor: pointer;" for="lV">lV year</label>
                                        </div>
                                        <div class="col-12 col-md-6">
