                    ...
                    <div class="col-md-6 order-sm-2 my-3">
                      <label for="dept" class="form-label">Department of Nominee:</label>
                        <select id="dept" name="dept" class="form-select" >
                          ...
                          <option value="ISE Department">ISE Department</option>
                          <option value="ME Department">ME Department</option>
                          <option value="EC Department">EC Department</option>
                          <option value="IOT Department">IOT Department</option>
                          <option value="AI Department">AI Department</option>
                          <option value="AE Department">AE Department</option>
                          <option value="MT Department">MT Department</option>
